...
function AdminMerchant() {
  ...
  const resDataPending = [
    {
      id: "#123456",
      ResName: "Reunion Cafe",
      contact: "9876543210",
      mail: "SouptikDas@gmail.com",
      saleRep: "Aneashwan Acharya",
    },
    {
      id: "#123456",
      ResName: "Reunion Cafe",
            ...
            <form className="mt-10">
              <div className="flex flex-col gap-8">
                <div className="flex flex-row gap-5">
                  <div className="w-[47%]">
                    <label
                      className="flex ml-4 mt-2 font-bold text-sm"
                      htmlFor="restaurantName"
                    >
                      Restaurant Name:
                    </label>
                    <input
                      className="rounded-lg shadow-sm ml-4 mt-1 px-4 py-3 w-full border border-gray-300"
                      type="text"
                      id="restaurantName"
                      name="restaurantName"
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center mt-1">
                    <input
                      className="rounded-lg shadow-sm ml-4  px-4 py-3 w-fit border border-gray-300"
                      type="checkbox"
                      name="openAllDay"
                      id="openAllDay"
                      ...
                      onChange={handleChange}
                    />
                    <label htmlFor="openAllDay" className="pl-2 text-sm">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-row gap-20 items-end">
                    ...
                    <div>
                      ...
                      <div className="ml-5 flex flex-row gap-4 mt-1">
                        <div className="flex flex-row gap-1 items-center">
                          ...
                          />
                          <label htmlFor="credit-cards" className="">
                            Credit Cards
                          </label>
                        </div>
                        <div className="flex flex-row gap-1 items-center">
                  ...
                  {/* upload file */}
                  <div
                    className="flex flex-row justify-center items-center w-72 h-32 border-2 border-dashed  border-yellow-600 rounded-lg bg-[#FEFCE8]"
                    onClick={() =>
              ...
              <div className="w-full flex justify-center mt-16">
                <div className="flex gap-4">
                  <button
                    ...
                    type="submit"
                    className="cursor-pointer px-2 font-roboto font-medium text-sm py-2 bg-yellow-500 text-white rounded-lg "
                  >
                    Create Merchants
                  </button>
                  <button
                    onClick={saveForLaterHandler}
                    className="cursor-pointer px-3 font-roboto font-medium text-sm py-2 border border-yellow-500 text-yellow-500 rounded-lg"
                  >
                    Save for later
                  </button>
                </div>
      ...
      <div className="flex pt-20" id="background">
        ...
        <div className="w-[80%] min-h-[100vh] bg-slate-200 p-8">
          ...
          <div className="w-[95%] mx-auto h-fit ">
            <div className="text-xl font-bold font-roboto">Performance</div>
            <div className="mt-4 flex justify-between">
              <div className="bg-white w-72 h-28 mt-2 rounded-2xl flex flex-col justify-evenly">
                ...
                <div className="flex justify-between p-2">
                  <p className="font-roboto text-2xl font-semibold">243090</p>
                </div>
              </div>
              <div className="bg-white w-72 h-28 mt-2 rounded-2xl flex flex-col justify-evenly">
                ...
                <div className="flex justify-between p-2">
                  <p className="font-roboto text-2xl font-semibold">120</p>
                </div>
              </div>
              <div className="bg-white w-72 h-28 mt-2 rounded-2xl flex flex-col justify-evenly">
                <div className="flex justify-between p-2">
                ...
                <div className="flex justify-between p-2">
                  <p className="font-roboto text-2xl font-semibold">21</p>
                </div>
              </div>
              <div className="bg-white w-72 h-28 mt-2 rounded-2xl flex flex-col justify-evenly">
                <div className="flex justify-between p-2">
                ...
                <div className="flex justify-between p-2">
                  <p className="font-roboto text-2xl font-semibold">24%</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="my-12 flex w-[95%] mx-auto justify-between">
            <div className="flex gap-2">
              <div
                className="bg-black text-white px-4 py-2 rounded-full text-sm font-roboto flex items-center justify-center cursor-pointer"
                onClick={one}
                id="one"
              >
                All Merchants
              ...
              <div
                className="bg-white px-4 py-2 rounded-full text-sm font-roboto flex items-center justify-center cursor-pointer"
                onClick={two}
                id="two"
              >
                Pending forms
            ...
            <div className="px-4 py-2 bg-yellow-400 rounded-lg">
              <div
                className="flex gap-1 text-white justify-center items-center cursor-pointer"
            ...
            <div className="my-4 ml-4">
              <form className="flex gap-1" onSubmit={submitHandlerAll}>
                <input
                  ...
                  className="w-[50%] p-3 bg-slate-200 rounded-lg font-bold"
                ></input>
                <button type="submit">
                  <GrSearch size={25} />
                </button>
                  ...
                  return (
                    <tr key={restaurant._id}>
                      <td className="py-4 px-4 whitespace-nowrap">
                        ...
                        <div className="text-sm">{restaurant.resturantId}</div>
                      </td>
          ...
          {/* two */}
          <div
            className="bg-white w-[95%] mx-auto border rounded-lg p-3 hidden"
            id="pending"
          >
            {/* search */}
            <div className="my-4 ml-4">
                ...
                {resDataPending?.map((restaurant) => {
                  return (
                    <tr key={restaurant.id}>
                      <td className="py-4 px-4 whitespace-nowrap">
                        <div className="text-sm">{restaurant.ResName}</div>
                      </td>
                      <td className="px-12 py-4 whitespace-nowrap">
                        <div className="text-sm">{restaurant.saleRep}</div>
                      </td>
                      <td className="px-4 py-4 whitespace-nowrap text-sm">
                        {restaurant.contact}
                      </td>
                      ...
                      <td className="px-4 py-4 whitespace-nowrap text-sm cursor-pointer">
                        <div className="bg-yellow-100 text-yellow-500 px-2 py-1 text-sm w-fit font-bold rounded-lg">
                          Edit Form
                        </div>
                      </td>
                    </tr>
              ...
              <tbody className="divide-y divide-gray-200">
                {searchNewData?.map((restaurant) => {
                  return (
                    <tr key={restaurant.id}>
                      <td className="py-4 px-4 whitespace-nowrap">
                        <div className="text-sm">{restaurant.rname}</div>
                      </td>
                      <td className="px-12 py-4 whitespace-nowrap">
