...
const AboutUs = () => {
    return (
        <div>
            ...
            <div>
                {/* First Part */}
                <div className='lg:h-[800px] h-[55vh] w-[100vw] my-auto overflow-hidden bg-slate-50 relative'>
                    ...
                    <div className='lg:w-[39.75rem] w-full mx-auto lg:h-[22rem] flex gap-[1.5rem] flex-col absolute lg:top-[28vh] top-36 lg:left-[7vw] text-center lg:text-left'>
                        ...
                        <div className='text-[#020617] text-2xl xl:text-7xl font-roboto font-semibold'>
                            Vision
                        </div>
                        <div className='font-opensans font-bold text-[#020617] -tracking-[2%] xl:text:lg'>
                            Elevate Dining Experience with SnackBae
                        </div>
                        <div className='font-normal text-sm text-[#020617] w-[31.875rem] font-opensans -tracking-[2%] xl:text-lg text-center lg:text-left mx-auto lg:mx-0'>
                ...
                {/* Second Part */}
                <div class=" bg-white relative mt-36 hidden lg:flex">
                ...
                <div className="flex flex-col border rounded-xl border-gray-400 py-10 px-20 my-10 w-full mx-auto mt-24 lg:hidden ">
                    <div>
                        <div className="mx-4">
                            <img
                                src={rect}
                            ...
                            ></img>
                            <img
                                className="absolute z-50 top-[60vh] -left-2  h-[44vw]"
                                src={ellipseB}
                                alt="Img"
                                loading="lazy"
                            ></img>
                ...
                <div className="bg-white">
                    ...
                    <div className='flex gap-[1.5rem] flex-col lg:ml-24 ml-12'>
                        <div className="w-[7.125rem] h-12 rounded-3xl py-1 px-4 gap-2.5 bg-amber-50 hidden lg:flex">
                            <div className=" font-roboto text-lg leading-9 font-semibold items-center text-[#EAB308] z-50 ">
                                Discover
                            </div>
                        </div>
                        <div className='text-[#020617] text-4xl lg:text-5xl font-roboto font-semibold'>
                            Meet the Team
                        </div>
                    </div>
                    <div className="lg:mx-24 mt-8 mx-10">
                        <TeamSlider />
                    </div>
                </div>
