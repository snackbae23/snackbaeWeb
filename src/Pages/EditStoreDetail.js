            ...
            <div className='flex  w-full mt-20 h-fit'>
                ...
                <div className="md:w-[75%] w-[85%] bg-slate-200  h-fit rounded-md p-6 md:ml-[22%] ml-[12%]">
                    ...
                    <div className='w-[100%]  bg-slate-200    rounded-md p-8 hidden h-[550px] ' id='b' >
                        ...
                        <div onClick={() => document.querySelector(".input-field").click()} className='w-full h-[170px] bg-yellow-50 flex justify-center items-center  mt-4  rounded-lg border-dashed border-2 border-yellow-400'>
