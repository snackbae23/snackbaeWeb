                        ...
                        <div className=' p-8   rounded-md '>
                            <div className='flex justify-between'>
                                ...
                                <div className='flex justify-center gap-10 pb-6'>
                                    <button className='bg-white border-[#EAB308] ring-2 ring-[#EAB308] p-2 w-32 h-10 rounded-[10px] ' onClick={isEditable ? handleCancelClick : handleEditDetailsClick}>
                                        <div className='text-[#EAB308]'>{isEditable ? 'Cancel' : 'Edit Details'}</div>
                                    </button>
                                    {isEditable ? (
                                        <button className='p-2 w-32 h-10 rounded-[10px] bg-[#EAB308] ' onClick={submitHandler}>
                                ...
                                <div>
                                    ...
                                    <div className='flex w-full justify-between mt-3 mb-2'>
                                        <div className='flex flex-col w-[48%] font-roboto'>
                                            <label className="" htmlFor="restaurantName">Business Name</label>
                                            {isEditable ? (
                                                <input
                                                    className="rounded-md mt-1 my-1.5 px-2 h-10 w-full text-[.92rem] text-slate-500 border-2 border-gray-300"
                                                    type="text"
                                    ...
                                    <div className='flex w-full justify-between mt-3 mb-2'>
                                        <div className='flex flex-col w-[48%] font-roboto'>
                                            ...
                                            {isEditable ? (
                                                ...
                                                <div className='px-2 rounded-md h-10 mt-1 text-[.92rem] border-2'>
                                                    <p className='flex items-center my-1.5 text-slate-500 font-roboto'>{data?.customerContact}</p>
                                                </div>
                                            )}
                                        </div>
                                        <div className='flex flex-col w-[48%] font-roboto'>
                                            ...
                                            {isEditable ? (
                                                ...
                                                <div className='px-2 rounded-md h-10 mt-1 text-[.92rem] border-2'>
                                                    <p className='flex items-center my-1.5 text-slate-500 font-roboto'>{data?.authorizedMail}</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div className='flex w-full justify-between mt-3 mb-2'>
                                        <div className='flex flex-col w-[47%]'>
                                            ...
                                            {isEditable ? (
                                                ...
                                                <div className='px-2 rounded-md h-10 mt-1 text-[.92rem] border-2'>
                                                    <p className='flex items-center my-1.5 text-slate-500 font-roboto'>{data?.openingHour}</p>
                                                </div>
                                            )}
                                        </div>
                                        ...
                                        <div className='flex flex-col w-[47%]'>
                                            ...
                                            {isEditable ? (
                                                ...
                                                <div className='px-2 rounded-md h-10 mt-1 text-[.92rem] border-2'>
                                                    <p className='flex items-center my-1.5 text-slate-500 font-roboto'>{data?.closingHour}</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                    <div className='flex w-full justify-between mt-3 mb-2'>
                                        <div className='flex flex-col w-[47%] font-roboto'>
                                            ...
                                            {isEditable ? (
                                                ...
                                                <div className='px-2 rounded-md h-10 mt-1 text-[.92rem] border-2'>
                                                    <p className='flex items-center my-1.5 text-slate-500 font-roboto'>{data?.offDay}</p>
                                                </div>
                                            )}
                                            {isEditable ? (
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            ...
                                                            if (e.target.checked) {
                                                                ...
                                                                setFormData({ ...formData, openAllDay: true, offDay: '' });
                                                            } else {

                                                                setFormData({ ...formData, openAllDay: false });
                                                            }
                                                        }} className={`w-5 h-5 rounded-md `} />
                                                    <label htmlFor="openAllDay" className="font-roboto ml-3 block text-sm font-medium text-slate-950">
                                    ...
                                    <div className='flex w-full justify-between mt-3 mb-2'>
                                        <div className='flex flex-col w-[47%]'>
                                            ...
                                            {isEditable ? (
                                                ...
                                                <div className='px-2 rounded-md h-10 mt-1 text-[.92rem] border-2'>
                                                    <p className='flex items-center my-1.5 text-slate-500 font-roboto'>{data?.capacity}</p>
                                                </div>
                                            )}
                                        </div>
                                        <div className='flex flex-col w-[47%]'>
                                            ...
                                            {isEditable ? (
                                                ...
                                                <div className='px-2 rounded-md h-10 mt-1 text-[.92rem] border-2'>
                                                    <p className='flex items-center my-1.5 text-slate-500 font-roboto'>{data?.numberOfTables}</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                    <div className='flex w-full justify-between mt-3 mb-2'>
                                        <div className='flex flex-col w-[47%]'>
                                            ...
                                            {isEditable ? (
                                                ...
                                                <div className='px-2 rounded-md h-10 mt-1 text-[.92rem] border-2'>
                                                    <p className='flex items-center my-1.5 text-slate-500 font-roboto'>{data?.FSSAInumber}</p>
                                                </div>
                                            )}
                                        </div>
                                        <div className='flex flex-col w-[47%]'>
                                            ...
                                            {isEditable ? (
                                                ...
                                                <div className='px-2 rounded-md h-10 mt-1 text-[.92rem] border-2'>
                                                    <p className='flex items-center my-1.5 text-slate-500 font-roboto'>{data?.salesRepresentative}</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
