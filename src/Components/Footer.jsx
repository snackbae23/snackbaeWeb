...
function Footer() 
{
    ...
    return (
        <div>
            {/* first section */}
            <div className='w-full h-[251px] bg-[#020617] flex flex-col justify-center items-center'>
            ...
            {/* second section */}
            <div className='w-full h-[290px] bg-[#0F172A]'>
                <div className='h-[85%] w-[85vw] flex flex-col gap-7 mx-auto'>
                    {/* first part */}
                    <div className='w-full mx-auto flex justify-between pt-9 '>
                        <div className='flex flex-col gap-2'>
                            <img src={logo} width={200}></img>
                            <div className='w-64 text-white opacity-80'>Discover and connect with our vibrant food community</div>
                        </div>
